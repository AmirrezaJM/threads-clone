...
<template>
    <div class="z-50 bottom-0 h-full w-full last:mb-40">
        <div class="py-2 w-full">
            <div class="flex items-center justify-between">
                <div class="flex items-center text-white">
                    <img class="rounded-full h-[35px]" :src="post.image" />
                    <div class="ml-2 font-semibold text-base">{{ post.name }}</div>
                </div>

                <div @click="isMenu = !isMenu" class="relative">
                    <button :disabled="isDeleting" :class="isMenu ? 'text-gray-800': ''" class="flex items-center justify-center text-white h-[24px] w-[24px] hover:bg-gray-800 rounded-full cursor-pointer">
            ...
            <div class="bg-black rounded-lg w-[calc(100%-50px)] text-sm w-full font-light">
                ...
                <div class="absolute mt-2 w-full ml-2">
                    <button
                        ...
                        <Icon name="mdi:cards-heart-outline" class="p-1 text-white hover:bg-gray-800 rounded-full cursor-pointer" size="28" />
                    </button>
